    ...
    <div className="bg-base-100">
        ...
        <div className="hero-content text-center">
          <div className="max-w-2xl">
            <h1 className="text-5xl font-bold">
              ByteResume – Let AI Be Your Career Wingman
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card bg-base-200 shadow-xl">
              <div className="card-body items-center text-center">
                ...
                <h3 className="card-title">Resume in Minutes</h3>
                <p>
                  Generate a professional, job-ready resume in less than 2 minutes with AI assistance.
                </p>
              </div>
            </div>
            {/* Feature 3 */}
            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                ...
                <div className="flex items-center mt-4">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold">Dev Patel</h4>
      ...
      <footer className="footer p-10 bg-base-200 text-base-content">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h4 className="footer-title">Byte Resume</h4>
            </div>
            <div>
              <h4 className="footer-title text-center">Quick Links</h4>
              <Link to={"/About"} className="link link-hover p-2">
                About Us
              </Link>
              <Link to={"/Services"} className="link link-hover p-2">
                Features
              </Link>
              <Link to={"/contact"} className="link link-hover p-2">
                Contact
              </Link>
            </div>
            <div>
              <h4 className="footer-title text-center">Legal</h4>
              <a href="#" className="link link-hover p-2 ">
                Privacy Policy
              </a>
              <a href="#" className="link link-hover p-2">
                Terms of Service
